...
namespace ManagerWeb.Controllers
{
    public class PaymentController : Controller
    {
        ...
        public JsonResult GetPaymentsData(DateTime fromDate)
        {
            ...
            payments.Add(new Payment { Amount = 2500, Date = new DateTime(2020, 7, 10), Id = 4, Name = "BTC" });
            payments.Add(new Payment { Amount = 300, Date = new DateTime(2020, 7, 20), Id = 4, Name = "DM", Description = "Mliko." });
            payments.Add(new Payment { Amount = 240, Date = new DateTime(2020, 7, 1), Id = 4, Name = "bendas" });
