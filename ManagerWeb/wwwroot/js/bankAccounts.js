...
/***/ "./Typescript/ApiClient/Main/apis/BankAccountApi.ts":
/*!**********************************************************!*\
  !*** ./Typescript/ApiClient/Main/apis/BankAccountApi.ts ***!
  \**********************************************************/
...
const runtime = __importStar(__webpack_require__(/*! ../runtime */ "./Typescript/ApiClient/Main/runtime.ts"));
...
/***/ "./Typescript/ApiClient/Main/apis/BudgetApi.ts":
/*!*****************************************************!*\
  !*** ./Typescript/ApiClient/Main/apis/BudgetApi.ts ***!
  \*****************************************************/
/*! no static exports found */
...
/***/ "./Typescript/ApiClient/Main/apis/CryptoApi.ts":
/*!*****************************************************!*\
  !*** ./Typescript/ApiClient/Main/apis/CryptoApi.ts ***!
  \*****************************************************/
/*! no static exports found */
...
/***/ "./Typescript/ApiClient/Main/apis/PaymentApi.ts":
/*!******************************************************!*\
  !*** ./Typescript/ApiClient/Main/apis/PaymentApi.ts ***!
  \******************************************************/
/*! no static exports found */
...
/***/ "./Typescript/ApiClient/Main/apis/TagApi.ts":
/*!**************************************************!*\
  !*** ./Typescript/ApiClient/Main/apis/TagApi.ts ***!
  \**************************************************/
/*! no static exports found */
...
/***/ "./Typescript/ApiClient/Main/apis/index.ts":
/*!*************************************************!*\
  !*** ./Typescript/ApiClient/Main/apis/index.ts ***!
  \*************************************************/
/*! no static exports found */
...
/***/ "./Typescript/ApiClient/Main/index.ts":
/*!********************************************!*\
  !*** ./Typescript/ApiClient/Main/index.ts ***!
  \********************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
__exportStar(__webpack_require__(/*! ./runtime */ "./Typescript/ApiClient/Main/runtime.ts"), exports);
__exportStar(__webpack_require__(/*! ./apis */ "./Typescript/ApiClient/Main/apis/index.ts"), exports);
__exportStar(__webpack_require__(/*! ./models */ "./Typescript/ApiClient/Main/models/index.ts"), exports);


/***/ }),

/***/ "./Typescript/ApiClient/Main/models/AddTagModel.ts":
/*!*********************************************************!*\
  !*** ./Typescript/ApiClient/Main/models/AddTagModel.ts ***!
  \*********************************************************/
/*! no static exports found */
...
const runtime_1 = __webpack_require__(/*! ../runtime */ "./Typescript/ApiClient/Main/runtime.ts");
/**
 *
 * @export
 * @class AddTagModel
...
/***/ "./Typescript/ApiClient/Main/models/BankAccountModel.ts":
/*!**************************************************************!*\
  !*** ./Typescript/ApiClient/Main/models/BankAccountModel.ts ***!
  \**************************************************************/
/*! no static exports found */
...
/***/ "./Typescript/ApiClient/Main/models/BankBalanceModel.ts":
/*!**************************************************************!*\
  !*** ./Typescript/ApiClient/Main/models/BankBalanceModel.ts ***!
  \**************************************************************/
/*! no static exports found */
...
/***/ "./Typescript/ApiClient/Main/models/BudgetModel.ts":
/*!*********************************************************!*\
  !*** ./Typescript/ApiClient/Main/models/BudgetModel.ts ***!
  \*********************************************************/
/*! no static exports found */
...
function BudgetModelFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'id': !(0, runtime_1.exists)(json, 'id') ? undefined : json['id'],
        'dateFrom': !(0, runtime_1.exists)(json, 'dateFrom') ? undefined : (new Date(json['dateFrom'])),
        'dateTo': !(0, runtime_1.exists)(json, 'dateTo') ? undefined : (new Date(json['dateTo'])),
...
/***/ "./Typescript/ApiClient/Main/models/PaymentModel.ts":
/*!**********************************************************!*\
  !*** ./Typescript/ApiClient/Main/models/PaymentModel.ts ***!
  \**********************************************************/
/*! no static exports found */
 ...
 */
Object.defineProperty(exports, "__esModule", { value: true });
exports.PaymentModelToJSON = exports.PaymentModelFromJSONTyped = exports.PaymentModelFromJSON = exports.PaymentModel = void 0;
const runtime_1 = __webpack_require__(/*! ../runtime */ "./Typescript/ApiClient/Main/runtime.ts");
/**
 *
 * @export
...
function PaymentModelFromJSON(json) {
    return PaymentModelFromJSONTyped(json, false);
}
exports.PaymentModelFromJSON = PaymentModelFromJSON;
function PaymentModelFromJSONTyped(json, ignoreDiscriminator) {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        ...
        'paymentTypeCode': !(0, runtime_1.exists)(json, 'paymentTypeCode') ? undefined : json['paymentTypeCode'],
        'paymentCategoryIcon': !(0, runtime_1.exists)(json, 'paymentCategoryIcon') ? undefined : json['paymentCategoryIcon'],
        'paymentCategoryCode': !(0, runtime_1.exists)(json, 'paymentCategoryCode') ? undefined : json['paymentCategoryCode'],
        'tags': !(0, runtime_1.exists)(json, 'tags') ? undefined : json['tags'],
    };
}
exports.PaymentModelFromJSONTyped = PaymentModelFromJSONTyped;
function PaymentModelToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.PaymentModelToJSON = PaymentModelToJSON;
...
/***/ "./Typescript/ApiClient/Main/models/TagModel.ts":
/*!******************************************************!*\
  !*** ./Typescript/ApiClient/Main/models/TagModel.ts ***!
  \******************************************************/
/*! no static exports found */
...
/***/ "./Typescript/ApiClient/Main/models/TradeHistory.ts":
/*!**********************************************************!*\
  !*** ./Typescript/ApiClient/Main/models/TradeHistory.ts ***!
  \**********************************************************/
/*! no static exports found */
...
function TradeHistoryFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'cryptoTicker': !(0, runtime_1.exists)(json, 'cryptoTicker') ? undefined : json['cryptoTicker'],
...
/***/ "./Typescript/ApiClient/Main/runtime.ts":
/*!**********************************************!*\
  !*** ./Typescript/ApiClient/Main/runtime.ts ***!
  \**********************************************/
/*! no static exports found */
...
class BankAccountOverview extends react_1.default.Component {
    constructor(props) {
        ...
        this.bankAccountApi = new Main_1.BankAccountApi(new Main_1.Configuration({ basePath: "https://localhost:5001" }));
