...
export interface PaymentClonePostRequest {
...
export interface PaymentApiInterface {
     ...
     * @memberof PaymentApiInterface
     */
    paymentClonePostRaw(requestParameters: PaymentClonePostRequest): Promise<runtime.ApiResponse<void>>;

    /**
     */
    paymentClonePost(requestParameters: PaymentClonePostRequest): Promise<void>;
...
export class PaymentApi extends runtime.BaseAPI implements PaymentApiInterface {
    ...
    /**
     */
    async paymentClonePostRaw(requestParameters: PaymentClonePostRequest): Promise<runtime.ApiResponse<void>> {
        const queryParameters: any = {};
    ...
    /**
     */
    async paymentClonePost(requestParameters: PaymentClonePostRequest): Promise<void> {
        await this.paymentClonePostRaw(requestParameters);
    }
