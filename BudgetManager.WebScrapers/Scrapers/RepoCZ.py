...
page = requests.get(
    f"{cnbBaseUrl}/cnb/STAT.ARADY_PKG.VYSTUP?p_period=1&p_sort=2&p_des=50&p_sestuid=41549&p_uka=3&p_strid=FBC&p_od=199301&p_do=202106&p_lang=CS&p_format=0&p_decsep=%2C")
