...
request = requests.get('https://roic.ai/financials/AAPL')
soup = BeautifulSoup(request.text, "html.parser")


# ------------------------------------------ GET MAIN FINANCIAL HISTORY ------------------------------------------
...
# ------------------------------------------ END - GET MAIN FINANCIAL HISTORY ------------------------------------------
...
#
# print(pe, fwd_pe, pe_to_sp, market_cap, div_yield)

# ------------------------------------------ END - GET MAIN SUMMARY ------------------------------------------

# ------------------------------------------ GET SUMMARY -----------------------------------------------------

# request = requests.get('https://roic.ai/company/AAPL')
# soup = BeautifulSoup(request.text, "html.parser")
# main = soup.findChild("main")
# children = main.findAll("div", recursive=False)[-1]
# children = children.findAll("div", recursive=False)[0]
...
description = children.findAll("div", recursive=False)[-1]
