...
class CryptoWatchService:
    ...
    def save_data_to_influx(self, priceData: List[Result], ticker):
        pointsToSave = []
        ...
        for priceModel in priceData:
            ...
            point = Point(measurement) \
                .tag("ticker", ticker) \
                .field('price', priceModel.close_val)
            point = point.time(priceModel.timestamp, WritePrecision.NS)
...
cryptoService.save_data_to_influx(btcData, CryptoTickers.BTC.value)