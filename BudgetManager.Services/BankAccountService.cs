...
namespace BudgetManager.Services
{
    internal class BankAccountService : IBankAccountService
    {
        ...
        //}
        public int AddBankAccount(BankAccountModel bankAccountViewModel) => throw new NotImplementedException();
        public void DeleteBankAccount(int id) => throw new NotImplementedException();
        public IEnumerable<BankAccountModel> GetAllBankAccounts() => throw new NotImplementedException();
        public IEnumerable<BankBalanceModel> GetBankAccountsBalanceToDate(DateTime? toDate) => throw new NotImplementedException();
        public void UpdateBankAccount(BankAccountModel bankAccountViewModel) => throw new NotImplementedException();
    }
}
