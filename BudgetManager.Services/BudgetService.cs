...
namespace BudgetManager.Services
{
    public class BudgetService : BaseService<BudgetModel, Budget, IBudgetRepository>, IBudgetService
    {
        ...
        public IEnumerable<BudgetModel> GetActual(int userId) => this.budgetRepository.FindByCondition(s => s.UserIdentityId == userId).ToList().Where(b => this.BudgetIsActual(b)).Select(b => b.MapToViewModel());
